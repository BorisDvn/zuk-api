...
public class ZukApiApplication implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        // Files
        File fileShoes = new File(null, "https://www.dropbox.com/s/yst40ux7dbvuq7i/93ebe910-9044-11ec-bfeb-e43d41b3a94d.jpg?raw=1", "Shoes");
        File fileClothes = new File(null, "https://www.dropbox.com/s/nnusvn9zbpmwjci/istockphoto-653003428-612x612.jpg?raw=1", "Clothes");
        File fileBooks = new File(null, "https://www.dropbox.com/s/ng3wkjaw15hidgz/f1b8d870-3653-11ea-b6c4-9d9f41070527.cf.jpg?raw=1", "Books");
        File fileTranslation = new File(null, "https://www.dropbox.com/s/2zl8t4on6gzr6ef/top-7-books-that-changed-the-world.jpg?raw=1", "Translation");
